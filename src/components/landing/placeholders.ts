...
export const services = [
  {
    ...
    icon: "Search",
    title: "리스팅 최적화",
    description: "제목, 설명, 사진 배치, 태그까지. 검색 노출을 극대화하는 리스팅으로 바꿔드립니다.",
    color: "purple",
  },
  {
    id: "sns",
    icon: "Instagram",
    title: "SNS 콘텐츠 제작",
    description: "인스타 릴스, TikTok 숏폼까지. 숙소에 맞는 템플릿 기반 콘텐츠를 매달 제작합니다.",
    color: "pink",
  },
  {
    id: "blog",
    icon: "FileText",
    title: "네이버 블로그 SEO",
    description: "내국인 게스트를 위한 네이버 블로그 포스팅과 검색 최적화를 대행합니다.",
    color: "green",
  },
  {
    id: "translation",
    icon: "Globe",
    title: "다국어 리스팅 번역",
    description: "영어, 일본어, 중국어 리스팅 번역과 현지화. 해외 게스트 유입을 높여드립니다.",
    color: "blue",
  },
  {
    id: "channel",
    icon: "BarChart3",
    title: "국적 기반 채널 전략",
    description: "게스트 국적 데이터를 분석해서 가장 효과적인 SNS 채널과 콘텐츠 방향을 추천합니다.",
    color: "orange",
  },
  {
    id: "pricing",
    icon: "CalendarDays",
    title: "이벤트 기반 가격 캘린더",
    description: "콘서트, 축제, 연휴 등 이벤트를 분석해 최적 가격 조정 시점을 알려드립니다.",
    color: "emerald",
  },
] as const;
